...
- [x]  If customer selects "Compute gallery" as the image source then it is customer's responsibility to ensure the high availability of the image used as mentioned in [here](https://learn.microsoft.com/azure/virtual-machines/azure-compute-gallery#high-availability).
