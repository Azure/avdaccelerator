...
- [Baseline](#baseline) - Azure Virtual Desktop
- [Custom Image Build](#custom-image-build) - Image Management using Azure Image Builder
...
This solution supports deployment into greenfield scenarios (no Azure infrastructure components exist) or brownfield scenarios (some Azure infrastructure components exist).
