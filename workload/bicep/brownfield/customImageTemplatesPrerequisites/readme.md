...
New-AzDeployment `
    ...
    -TemplateFile 'https://raw.githubusercontent.com/Azure/avdaccelerator/main/workload/arm/brownfield/deployCustomImageTemplatesPrerequisites.json' `
    -Verbose
````
...
az deployment sub create \
    --location '<Azure location>' \
    --template-uri 'https://raw.githubusercontent.com/Azure/avdaccelerator/main/workload/arm/brownfield/deployCustomImageTemplatesPrerequisites.json'
````
