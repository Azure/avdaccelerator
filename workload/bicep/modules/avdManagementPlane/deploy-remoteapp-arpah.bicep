...
module applicationGroups '../../../../avm/1.0.0/res/desktop-virtualization/application-group/main.bicep' = [for applicationGroup in varApplicationGroups: {
  ...
  params: {
    ...
    tags: tags
    applications: varRAppApplicationGroupsApps
...
resource existingWorkspace 'Microsoft.DesktopVirtualization/workspaces@2023-11-01-preview' existing = {
  scope: resourceGroup('${subscriptionId}', '${serviceObjectsRgName}')
  name: workSpaceName
}

// resource updateWorkspace 'Microsoft.DesktopVirtualization/workspaces@2023-11-01-preview' {
//   name: workSpaceName
//   scope: resourceGroup('${subscriptionId}', '${serviceObjectsRgName}')
