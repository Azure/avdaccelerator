...
module managementVm './managementVm.bicep' = if (avdIdentityServiceProvider != 'EntraID' && (createFslogixDeployment || createAppAttachDeployment)) {
  ...
  params: {
    ...
    location: location
    vmSize: avdSessionHostsSize //'Standard_D2ads_v5'
