...
var varUserAssignedManagedIdentityName = customNaming
  ? userAssignedManagedIdentityCustomName
  : 'id-aib-${varNamingStandard}'
...
module roleDefinitions './modules/rbacRoles/roleDefinitionsSubscriptions.bicep' = [
