...
@sys.description('The secret name for the host pool registration.')
param hostPoolRegistrationTokenSecretName string
...
module keyVaultHostPoolSecret '../../../../../avm/1.0.0/res/key-vault/vault/secret/main.bicep' = {
  ...
  params: {
    ...
    name: hostPoolRegistrationTokenSecretName
