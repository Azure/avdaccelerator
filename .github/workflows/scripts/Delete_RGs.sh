...
resource_groups=("avd-nih-arpah-$1-use2-monitoring" "avd-nih-arpah-$1-use2-network" "avd-nih-arpah-$1-use2-pool-compute" "avd-nih-arpah-$1-use2-service-objects" "rg-avd-$1-use2-monitoring")
